...
ENV HEADSCALE_ADVERTISE_PROTO=http
ENV HEADSCALE_ADVERTISE_ADDR=127.0.0.1
ENV HEADSCALE_ADVERTISE_PORT=8514
ENV HEADSCALE_MAGICDNS_ENABLED=true
ENV HEADSCALE_MAGICDNS_DOMAIN=headscale.local
